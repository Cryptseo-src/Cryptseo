Contributing to CSEO
============================

The CSEO project operates an open contributor model where anyone is
...
The following applies to code changes to the CSEO project, and is not to be
confused with overall CSEO Network Protocol consensus changes.

Whether a pull request is merged into CSEO rests with the project merge
...
Patches that change CSEO consensus rules are considerably more involved than
...
Where a patch set proposes to change the CSEO consensus, it must have been
...
The project leader is the release manager for each CSEO release.

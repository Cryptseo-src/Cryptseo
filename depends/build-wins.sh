...
[ -f "./src/qt/cryptseo-qt.exe" ] && cp "./src/qt/cryptseo-qt.exe" "$RELEASE"
[ -f "./src/cryptseod.exe" ] && cp "./src/cryptseod.exe" "$RELEASE"
[ -f "./src/cryptseo-cli.exe" ] && cp "./src/cryptseo-cli.exe" "$RELEASE"

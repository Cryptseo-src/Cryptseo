...
from test_framework.test_framework import CryptseoTestFramework, SkipTest
...
class ZMQTest (CryptseoTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that cryptseo has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("cryptseod has not been built with zmq enabled.")

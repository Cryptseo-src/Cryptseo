...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CryptseoTestFramework
    pass

class ExampleTest(CryptseoTestFramework):
    # Each functional test is a subclass of the CryptseoTestFramework class.
    ...
    def custom_method(self):
        ...
        CryptseoTestFramework class so other tests can use it."""

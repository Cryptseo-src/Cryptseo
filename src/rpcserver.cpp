...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cryptseo features */
        {"cryptseo", "masternode", &masternode, true, true, false},
        //{"cryptseo", "masternodelist", &masternodelist, true, true, false},
        //{"cryptseo", "mnbudget", &mnbudget, true, true, false},
        //{"cryptseo", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"cryptseo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"cryptseo", "mnsync", &mnsync, true, true, false},
        {"cryptseo", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"cryptseo", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> cryptseo-cli " + methodname + " " + args + "\n";
}

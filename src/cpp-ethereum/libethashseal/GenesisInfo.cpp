...
#include "genesis/cryptseoMainNetwork.cpp"
#include "genesis/cryptseoTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::cryptseoMainNetwork: return c_genesisInfoCryptseoMainNetwork;
	case Network::cryptseoTestNetwork: return c_genesisInfoCryptseoTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::cryptseoMainNetwork: return c_genesisStateRootCryptseoMainNetwork;
	case Network::cryptseoTestNetwork: return c_genesisStateRootCryptseoTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}

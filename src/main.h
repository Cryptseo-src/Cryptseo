...
/////////////////////////////////////////// cryptseo
#include <cryptseo/cryptseostate.h>
#include <cryptseo/cryptseoDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <cryptseo/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<CryptseoState> globalState;
...
using ExtractCryptseoTX = std::pair<std::vector<CryptseoTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
#define WORKING_VERSION "/CSEO:5.3.0/"
#endif

static const int64_t DARKSEND_COLLATERAL = (16120*COIN); //1000 CSEO
static const int64_t DARKSEND_FEE = (0.002*COIN); // reward masternode
static const int64_t DARKSEND_POOL_MAX = (1999999.99*COIN);

static const int nCryptseoProtocolSwitchHeight = 580000;
...
extern unsigned int dgpMaxBlockSize; // cryptseo
...
class CryptseoTxConverter{

public:

    CryptseoTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionCryptseoTransactions(ExtractCryptseoTX& cryptseoTx);
...
private:
    ...
    CryptseoTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<CryptseoTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
...
private:
    ...
    std::vector<CryptseoTransaction> txs;

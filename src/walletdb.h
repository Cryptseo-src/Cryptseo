...
public:
    ...
    bool WriteCryptseoNodeConfig(std::string sAlias, const CCryptseoNodeConfig& nodeConfig);
    bool ReadCryptseoNodeConfig(std::string sAlias, CCryptseoNodeConfig& nodeConfig);
    bool EraseCryptseoNodeConfig(std::string sAlias);

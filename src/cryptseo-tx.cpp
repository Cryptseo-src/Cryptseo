...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CSEO cryptseo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptseo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptseo transaction") + "\n" +
                               "  cryptseo-tx [options] -create [commands]   " + _("Create hex-encoded cryptseo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptseo transaction

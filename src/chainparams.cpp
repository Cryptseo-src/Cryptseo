...
static Checkpoints::MapCheckpoints mapCheckpoints = boost::assign::map_list_of
                ...
                ( 1,   uint256("0x0000089d7c3e6684358340542e8182c29a09337af2f9bac75ac98d7bd541bdef") )
                ( 100,   uint256("0x00000d5581dc76e2586f0b07a83d651c2ce4d9152d7c70ff31979604c03116ec") )
...
public:
    CMainParams()
    {
        ...
        consensus.powLimit = ~uint256(0) >> 20; // CSEO starting difficulty is 1 / 2^12
        ...
        nModifierUpdateBlock = 6; //615800
        
        strProxyPoolAddress = "CS2mbtVaU5cFJpXmyQr6be81WVXzfGDe5z";
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
        vSeeds.push_back(CDNSSeedData("2603:6000:d809:4e09:77:99ea:4a7d:ab", "2603:6000:d809:4e09:77:99ea:4a7d:ab"));       // CSEO seeder (IPv6)
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28); // CSEO address start with 'C'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,63); // CSEO script addresses start with 'S'
...
public:
    CTestNetParams()
    {
        ...
        //consensus.BIP34Height = 227931;
        //consensus.BIP34Hash = uint256S("0x000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8");
        consensus.powLimit = ~uint256(0) >> 10; // CSEO starting difficulty is 1 / 2^12
        consensus.nPowTargetTimespan = 30 * 60; //36 * 60 * 60; // CSEO: 1 36hrs
        consensus.nPowTargetSpacing = 2 * 60;  // CSEO: 2 minute
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // cryptseo
        genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // cryptseo
       ...
       // std::cout << genesis.hashMerkleRoot.GetHex() << std::endl;
        ...
        //vFixedSeeds.clear();
        //vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("Seed1", "cryptseov2.mealcryptseos.biz"));       // CSEO seeder
		//vSeeds.push_back(CDNSSeedData("65.30.166.214", "65.30.166.214"));
        //vSeeds.push_back(CDNSSeedData("172.68.174.87", "172.68.174.87"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 48); // Testnet cryptseo addresses start with 'l'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 63);  // Testnet cryptseo script addresses start with 'S'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 155);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cryptseo BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cryptseo BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cryptseo BIP44 coin type is '1' (All coin's testnet default)
        // CSEO BIP44 coin type is '1'
        nExtCoinType = 1;
        bech32_hrp = "tb";
...
public:
    CRegTestParams()
    {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Cryptseo: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // Cryptseo: 1 minutes
...
public:
    CSegWitTestnet()
    {
        ...
        consensus.nPowTargetSpacing = 60;  // CSEO: 1 minute
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48); // CSEO Start letter L

 ...
 * CSEO system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string GetProxyPoolAddress() const { return  strProxyPoolAddress; }
...
protected:
    ...
    std::string strProxyPoolAddress;
};

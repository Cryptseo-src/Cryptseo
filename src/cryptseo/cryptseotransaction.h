#ifndef CSEOTRANSACTION_H
#define CSEOTRANSACTION_H
...
class CryptseoTransaction : public dev::eth::Transaction{

public:

    CryptseoTransaction() : nVout(0) {}

    CryptseoTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    CryptseoTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):

...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("CSEO RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  cryptseo-cli [options] <command> [params]  " + _("Send command to CSEO") + "\n" +
                        "  cryptseo-cli [options] help                " + _("List commands") + "\n" +
                        "  cryptseo-cli [options] help <command>      " + _("Get help for a command") + "\n";

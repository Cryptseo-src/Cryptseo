	...
	ui(new Ui::UpdateInfoDialog)
{
	...
	QString url = "https://github.com/Cryptseo/Cryptseo/releases";
...
UpdateInfoDialog::DialogResult UpdateInfoDialog::showUpdateInfo(QList<CryptseoUpdater::CryptseoUpdateInfo> updates, bool &runAsAdmin, bool editable, bool detailed, QWidget *parent)
{
	if(!detailed) {
...
void QtCryptseoUpdater::UpdateInfoDialog::on_acceptButton_clicked()
{
...
void QtCryptseoUpdater::UpdateInfoDialog::on_delayButton_clicked()
{

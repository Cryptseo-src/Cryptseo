...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(CSEO);
    unitlist.append(mCSEO);
    unitlist.append(uCSEO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case CSEO:
        return QString("cryptseo");
    case mCSEO:
        return QString("mcryptseo");
    case uCSEO:
        return QString::fromUtf8("ucryptseo");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CSEO:
            return QString("CSEO");
        case mCSEO:
            return QString("mCSEO");
        case uCSEO:
            return QString::fromUtf8("μCSEO");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case CSEO:
            return QString("tCSEO");
        case mCSEO:
            return QString("mtCSEO");
        case uCSEO:
            return QString::fromUtf8("μtCSEO");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CSEO:
            return QString("CSEO");
        case mCSEO:
            return QString("Milli-CSEO (1 / 1" THIN_SP_UTF8 "000)");
        case uCSEO:
            return QString("Micro-CSEO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case CSEO:
            return QString("TestCSEOs");
        case mCSEO:
            return QString("Milli-TestCSEO (1 / 1" THIN_SP_UTF8 "000)");
        case uCSEO:
            return QString("Micro-TestCSEO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }

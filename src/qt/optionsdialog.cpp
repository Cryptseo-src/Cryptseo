...
void OptionsDialog::setModel(OptionsModel* model)
{
    ...
    // if set in cryptseo.conf or in startup command line, sync and gray the checkboxes
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeCryptseo, OptionsModel::AnonymizeCryptseoAmount);

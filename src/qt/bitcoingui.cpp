...

{
    ...
    resize(1200, 750);
    QString windowTitle = tr("Cryptseo") + " - ";

#ifdef ENABLE_UPDATER
    controller = new QtCryptseoUpdater::UpdateController(QStringLiteral("v5.3.0"), this);
...
#endif // ENABLE_WALLET
    if (enableWallet) {
        windowTitle += tr("Crypto SEO Services");
    } else {
        windowTitle += tr("Node via Mealcryptseos.biz");
    }
    ...
    //fill in frameSocMedia
    {
        ...
        connect(pushButtonGithub, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://github.com/Cryptseo/Cryptseo"));});
    ...
    {
        QString url = "https://github.com/CSEO-Core/cryptseo/releases";
        QString link = QString("<a href=\\\"\"+ url +\"\\\">\"+ url +\"</a>").arg(NEW_RELEASES, NEW_RELEASES);
        QString message(tr("New cryptseo-qt version available: <br /> %1. <br />").arg(link));
...
void BitcoinGUI::createActions() {
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CSEO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptseo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/cryptseocoin_black"), tr("&About Cryptseocore"), this);
    aboutAction->setStatusTip(tr("Show information about Cryptseocore"));
    aboutAction->setMenuRole(QAction::AboutRole);

#ifdef ENABLE_UPDATER
    // Check for update menu item
    checkForUpdateAction = new QAction(QIcon(":/icons/update_black"), tr("Check for &Update"), this);
    checkForUpdateAction->setStatusTip(tr("Check whether there is an updated wallet from Cryptseocore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CSEO"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/cryptseocoin_black"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CSEO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verified"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CSEO addresses"));
    ...
    openAction->setStatusTip(tr("Open a CSEO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    openHexAddressAction = new QAction(QIcon(":/icons/editcopy"), tr("&Hex Address Converter"), this);
    openHexAddressAction->setStatusTip(tr("Converter for CSEO Smart Contract addresses"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cryptseocore help message to get a list with possible CSEO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle) {
    ...
    QString toolTip = tr("Cryptseocore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updaterClicked() {
    if (!clientModel)
        return;
#ifdef ENABLE_UPDATER
    controller->start(QtCryptseoUpdater::UpdateController::ProgressLevel);
#else
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (clientModel->getNetworkActive())
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cryptseocore network", "", count));
    else
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
    QString strTitle = tr("Cryptseo"); // default title

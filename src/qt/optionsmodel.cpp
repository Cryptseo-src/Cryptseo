...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::CSEO);
    ...
    if (!settings.contains("nAnonymizeCryptseoAmount"))
        settings.setValue("nAnonymizeCryptseoAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCryptseoAmount = settings.value("nAnonymizeCryptseoAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeCryptseoAmount"))
        SoftSetArg("-anonymizecryptseoamount", settings.value("nAnonymizeCryptseoAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cryptseo.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeCryptseoAmount:
            return QVariant(nAnonymizeCryptseoAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case DarkSendRounds:
            ...
            break;
        case AnonymizeCryptseoAmount:
            nAnonymizeCryptseoAmount = value.toInt();
            settings.setValue("nAnonymizeCryptseoAmount", nAnonymizeCryptseoAmount);
            Q_EMIT anonymizeCryptseoAmountChanged(nAnonymizeCryptseoAmount);
            break;
        case CoinControlFeatures:

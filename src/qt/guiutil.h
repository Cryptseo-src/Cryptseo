...
/** Utility functions used by the CSEO Qt UI.
 */
namespace GUIUtil
{
...
// Render CSEO addresses in monospace font
...
// Parse "cryptseo:" URI into recipient object, return true on successful parsing

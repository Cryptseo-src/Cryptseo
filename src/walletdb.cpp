...
bool CWalletDB::WriteCryptseoNodeConfig(std::string sAlias, const CCryptseoNodeConfig& nodeConfig)
{
    nWalletDBUpdateCounter++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadCryptseoNodeConfig(std::string sAlias, CCryptseoNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseCryptseoNodeConfig(std::string sAlias)
{
    nWalletDBUpdateCounter++;

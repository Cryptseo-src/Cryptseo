...
RESOURCES += src/qt/cryptseo.qrc src/qt/cryptseo_locale.qrc

TRANSLATIONS += src/qt/locale/cryptseo_bg.ts \
                src/qt/locale/cryptseo_de.ts \
                src/qt/locale/cryptseo_en.ts \
                src/qt/locale/cryptseo_es.ts \
                src/qt/locale/cryptseo_fi.ts \
                src/qt/locale/cryptseo_fr.ts \
                src/qt/locale/cryptseo_it.ts \
                src/qt/locale/cryptseo_ja.ts \
                src/qt/locale/cryptseo_pl.ts \
                src/qt/locale/cryptseo_pt.ts \
                src/qt/locale/cryptseo_ru.ts \
                src/qt/locale/cryptseo_sk.ts \
                src/qt/locale/cryptseo_sv.ts \
                src/qt/locale/cryptseo_vi.ts \
                src/qt/locale/cryptseo_zh_CN.ts \
                src/qt/locale/cryptseo_zh_TW.ts

...
This means one can have an always-on cryptseod instance running, and another local cryptseod/cryptseo-qt instance which connects to this node and receives blocks from it.

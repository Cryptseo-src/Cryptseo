...
Acquire the source and install dependencies.
    ...
    git clone https://github.com/Cryptseo/Cryptseo
    sudo chmod -R a+rw cryptseo
    cd cryptseo/depends
...
Use
    ...
    sudo add-apt-repository ppa:bitcoin/bitcoin; git clone https://github.com/Cryptseo/Cryptseo; cd cryptseo; depends/install-dependencies.sh; ./autogen.sh; ./configure --disable-tests --with-boost-libdir=/usr/local/lib; make clean; make -j$(nproc)
...
Clone the Cryptseo source code and cd into cryptseo
...
completely stable. [Tags](https://github.com/Cryptseo/Cryptseo/tags) are created
regularly to indicate new official, stable release versions of Cryptseo.
...
## License
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2F216k155%2Fcryptseo.svg?type=large)](https://app.fossa.io/projects/git%2Bgithub.com%2F216k155%2Fcryptseo?ref=badge_large)

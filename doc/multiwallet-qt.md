...
In order to support loading of multiple wallets in cryptseo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptseo.cpp.
...
Changes to cryptseo.cpp
----------------------
cryptseo.cpp is the entry point into cryptseo-qt, and as such, will require some minor modifications to provide hooks for

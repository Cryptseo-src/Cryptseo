...
Technical description of the implementation of a distributed file storage based on the CSEO blockchain
==========================================================================================================
...
Let's introduce several abbreviations used in the text below:
    ...
    - PMN - parallel masternode. A new layer of masternodes of the Cryptseocoin network that implements dfs functionality 
      using its own protocol. PMNs are completely independent of the usual Cryptseocoin masternodes networks and 
      not support their protocol. PMN organize a network among themselves, by analogy with the usual masternodes.
   
    - To install a PMN, a Cryptseocoin network user should not undergo additional checks or block any amounts of coins 
    ...
    - A user of any cryptseo network node may request to add multiple copies of his file(s) to the PMN network for a 
    ...
    - The user of any node of the cryptseo network node can download the file saved in dfs, specifying the Merkle root 
      of the desired file.
    
    - The user of any node of the cryptseo network node can check a file saved in dfs, indicating Merkle root the 
      desired file.

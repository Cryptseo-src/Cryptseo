...
This mechanism has been integrated into Bitcore-Node-CSEO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CSEO-Project/insight-api-cryptseo#web-socket-api](https://github.com/CSEO-Project/insight-api-cryptseo#web-socket-api) 
* API: [https://github.com/CSEO-Project/insight-api-cryptseo#instantx-transactions](https://github.com/CSEO-Project/insight-api-cryptseo#instantx-transactions)
...
By default, the CSEO daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CSEO daemon:

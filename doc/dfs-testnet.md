![CSEO Logo](../src/qt/res/images/cryptseo_logo_horizontal.png)
...
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2F216k155%2Fcryptseo.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2F216k155%2Fcryptseo?ref=badge_shield) [![Build Status](https://travis-ci.org/CSEO-Core/cryptseo.svg?branch=master)](https://travis-ci.org/CSEO-Core/cryptseo) [![GitHub version](https://badge.fury.io/gh/CSEO-Core%2Fcryptseo.png)](https://badge.fury.io/gh/CSEO-Core%2Fcryptseo.png) [![HitCount](http://hits.dwyl.io/216k155/cryptseo.svg)](http://hits.dwyl.io/216k155/cryptseo)
<a href="https://discord.gg/A6YW6uh"><img src="https://discordapp.com/api/guilds/364500397999652866/embed.png" alt="Discord server" /></a> <a href="https://twitter.com/intent/follow?screen_name=CSEO_COIN"><img src="https://img.shields.io/twitter/follow/CSEO_COIN.svg?style=social&logo=twitter" alt="follow on Twitter"></a>
                                                                                                                                                     
[Website](https://mealcryptseos.biz) — [CSEOtre + CSEOGate](https://github.com/Cryptseo/Cryptseotre) - [PoS Web Wallet](https://cryptseo.poswallet.io) — [Block Explorer](https://explorer.mealcryptseos.biz/) — [Blog](https://reddit.com/r/CSEOCoin) — [Forum](https://bitcointalk.org/index.php?topic=2254046.0) — [Telegram](https://t.me/CSEOcoinOfficialChat) — [Twitter](https://twitter.com/CSEO_Coin)
...
Example:
    ...
    cryptseo/src/cryptseo-cli -testnet=1 -rpcpassword=123456 help dfsannounce
...
As a result, you should see:
        ...
        "myip": "45.32.245.24:28333",
         "dfsfolder": "/root/cryptseotestnet/testnet4/dfs",
         "dfstempfolder": "/root/cryptseotestnet/testnet4/dfstemp",
         "rate": 1,
         "maxblocksgap": 100
        }
...
To send a file you need to make an rpc call `dfsannounce`:
        ...
        cryptseo/src/cryptseo-cli -testnet=1 -rpcpassword=123456 dfsannounce "/root/file.test" 100 200

Where `/root/file.test` is the path to the file you want to save, `100` is the maximum file storage cost, measured in `1Kb * 1sec / 0.00000001 cryptseo`, and `200` is the maximum number of blocks, the allowable intervals between transactions containing evidence of file storage.
...
Example:
    ...
    cryptseo/src/cryptseo-cli -testnet=1 -rpcpassword=123456 dfslistproposals f37996a118cc14e16a300503ef23062f6711721ebcce1ed9df91680cdeee0c40 
...
Moreover, You can check it with corresponding command below: 
    ...
    cryptseo/src/cryptseo-cli -testnet=1 -rpcpassword=123456 dfslocalstorage
    ...
    [
     {
       "index": 0,
       "type": "storage chunk",
       "path": "/root/cryptseotestnet/testnet4/dfs",
       "totalSpace": "107374182400",
       "freeSpace": "107374114688",
       "files": [{
       "filename": "/root/cryptseotestnet/testnet4/dfs/667cb29cf32f3bb48d875d33e2b61d16996b606d0f42acdd6b254ba1ce3cd8ac_1548331987.cryptseofs",
     ...
     
     {
       "index": 0,
       "type": "temp chunk",
       "path": "/root/cryptseotestnet/testnet4/dfstemp",
       "totalSpace": "107374182400",
...
Also, the actual availability of this file and its size can be inspected using the usual bash tools at the address specified in the filename section (in this case `"filename"`):
    ...
    "/root/cryptseotestnet/testnet4/dfs/667cb29cf32f3bb48d875d33e2b61d16996b606d0f42acdd6b254ba1ce3cd8ac_1548331987.cryptseofs")
...
Example:
    ...
    cryptseo/src/cryptseo-cli -testnet=1 -rpcpassword=123456 dfsdecrypt "f37996a118cc14e16a300503ef23062f6711721ebcce1ed9df91680cdeee0c40" "/root/file.test"
